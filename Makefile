...
drs_expert.o: src/drs_expert.cpp src/Waveform.cpp src/defines.h src/ChargeHist.cpp src/Cs_fit.cpp src/Ba_fit.cpp src/Na_fit.cpp src/Co_fit.cpp src/drs_menu.cpp src/volt_fit.cpp src/bananas.cpp include/mxml.h include/DRS.h src/HVPowerSupply.cpp  include/HVPowerSupply.h   
	$(CXX) $(CFLAGS)  `root-config --cflags` -c $<
